...
//Genders es un array de generos, vamos a ver si contiene rpg
const rpgGames = videogames.filter((game) => game.genders.includes("RPG"));
console.log(rpgGames);

//calculo la suma de los score de estos juegos
const totalScore = rpgGames.reduce((acc, game) => acc + game.score, 0);

//divido entre el número de rpgs para sacar la media
const mediaRpg = totalScore / rpgGames.length;
