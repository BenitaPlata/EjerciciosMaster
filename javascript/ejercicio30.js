...
for (const track of tracks) {
  const genre = track.genre; //obtengo el genero de las canciones
  if (!groupedByGenre[genre]) {
    groupedByGenre[genre] = []; //si el genero no existe lo creo
  }

  groupedByGenre[genre].push(track); //agrego la canción al array del genero
}
