...
for (const scannerUsers of users) {
  if (scannerUsers.years >= 18) {
    console.log(`El usuario ${scannerUsers.name} es mayor de edad.`);
  } else {
    console.log(`El usuario ${scannerUsers.name} es menor de edad.`);
  }
}
